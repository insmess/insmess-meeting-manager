<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="即讯会议系统的会议id" prop="imMeetingId">
        <el-input
          v-model="queryParams.imMeetingId"
          placeholder="请输入即讯会议系统的会议id"
          clearable
    ...
    <el-table v-loading="loading" :data="meetingList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="即讯会议系统的会议id" align="center" prop="imMeetingId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="即讯会议系统的会议id" prop="imMeetingId">
          <el-input v-model="form.imMeetingId" placeholder="请输入即讯会议系统的会议id" />
        </el-form-item>
      </el-form>
